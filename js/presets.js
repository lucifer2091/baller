window.PRESETS = {
  ...
  BALL_PRESETS: {
    ...
    Sword: {
      ...
      critMultiplier: 2.5,
      knockback: 30,
      description: "Fast melee attacker with high damage"
    },
    Hammer: {
      name: "Hammer",
      hp: 600,
      ...
      critMultiplier: 3,
      knockback: 50,
      description: "Slow but devastating heavy hitter"
    },
    Laser: {
      name: "Laser",
      hp: 300,
    ...
    Speed: {
      ...
      critMultiplier: 2,
      knockback: 15,
      description: "Extremely fast hit-and-run"
    },
    Tank: {
      name: "Tank",
      hp: 1000,
      ...
      critMultiplier: 2,
      knockback: 10,
      description: "High HP slow-moving fortress"
    },
    Berserker: {
      name: "Berserker",
      hp: 350,
      ...
      critMultiplier: 3,
      knockback: 35,
      description: "Gets stronger as HP drops"
    },
    Shield: {
      name: "Shield",
      hp: 700,
      ...
      critMultiplier: 2,
      knockback: 20,
      description: "Defensive fighter with high block"
    },
    Swarm: {
      name: "Swarm",
      hp: 150,
