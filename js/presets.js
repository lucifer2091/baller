window.PRESETS = {
  ...
  ARENA_PRESETS: {
    "Classic Box": {
      ...
      width: 250,
      height: 250,
      description: "Small 1v1 box with gravity",
      gravity: 1,
  ...
  MATCH_MODIFIERS: {
    base: { wallSpeedBoost: { enabled: false, amount: 0.02, cap: 3 }, gravity: 0.5, scatteredOrbs: { enabled: false, type: "heal", healAmount: 80, rotMult: 1.5, rotDuration: 6 } },
